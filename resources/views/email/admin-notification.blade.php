                                    ...
                                    <table class="devicewidthinner" align="center" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 30px; color: #333333; text-align:center; line-height: 30px;"
                                                ...
                                                <p align="left">
                                                    <span style="font-size: 14pt;" class="im"><span style="font-size: 14pt;">Hello
                                                            ,</span><br><span style="font-size: 14pt;">
                                                            A user has commented on a post. Please click on the link to </span><span
                                                                style="font-size: 14pt;"><a
                                                                    style="color:rgb(250,0,51);text-decoration:none"
                                                                    href="{{ url('/').'/'.$link}}">Open Comment</a> </span></span>
                                                </p>
                                            </td>
                                        </tr>
                                                    ...
                                                    <tr>
                                                        <td class="devicewidth" height="93" align="center" width="">
                                                            <div class="imgpop" style="background-color:rgb(250,0,51);min-height:50px;min-width:225px;text-align: center; line-height:50px;">
                                                                <a style=" color:white;font-weight: bold;" href="{{  url('/').'/'.$link }}">Open Comment</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <!-- Content -->
