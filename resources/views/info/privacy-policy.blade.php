...
@section('body-class'){{ 'privacy-policy-page' }}@stop
...
@section('content')
        ...
        <div class="container mid-bottom-container">
                <p>This privacy policy has been
                ...
                <h5>What personal information do we collect from the people that visit our
                        blog, website or app?</h5>

                <p>When ordering or registering on
                    our site, as appropriate, you may be asked to enter your name, email address,
                    mailing address, phone number, credit card information or other details to help
                    you with your experience.</p>

                <p><b>When do we collect information?</b></p>

                <p>We collect information from you
                    when you register on our site, place an order, subscribe to a newsletter or enter
                ...
                <p>We may use the information we
                    ...
                    or use certain other site features in the following ways:</p>

                

                <p><b>•</b>
                    To personalize user's experience and to allow us to deliver the type of content
                    and product offerings in which you are most interested.</p>

                <p><b>•</b>
                    To improve our website in order to better serve you.</p>
                ...
                <p>Your personal information is
                ...
                <p>We implement a variety of
                    security measures when a user places an order enters, submits, or accesses
                    their information to maintain the safety of your personal information.</p>

                

                <p>All transactions are processed
                    through a gateway provider and are not stored or processed on our servers.</p>

                

                <p><b>Do we use 'cookies'?</b></p>

                <p>Yes. Cookies are small files that
                ...
                <p><b>•</b>
                    Help remember and process the items in the shopping cart.</p>

                <p><b>•</b>
                    Understand and save user's preferences for future visits.</p>

                <p><b>•</b>
                    Keep track of advertisements.</p>
                ...
                <p><b>•</b>
                    ...
                    third-party services that track this information on our behalf.</p>

                

                <p>You can choose to have your
                    ...
                    settings. Each browser is a little different, so look at your browser's Help menu
                    to learn the correct way to modify your cookies.</p>

                <p>If you disable cookies off, some
                    features will be disabled. It won't affect the user's
                    experience that make your site experience more efficient and some of our
                    services will not function properly.</p>
                <p>However, you can still placeorders.</p>


                <p><b>Third-party disclosure</b></p>

                <p>We do not sell, trade, or
                    ...
                    to keep this information confidential. We may also release information when it's  release is appropriate to comply with the law, enforce
                    our site policies, or protect ours or others' rights, property, or safety. </p>

                

                <p>However, non-personally
                ...
                <p>Google's advertising requirements
                ...
                <p>We use Google AdSense Advertising
                    on our website.</p>

                

                <p>Google, as a third-party vendor,
                ...
                <p>Users can set preferences for how
                    ...
                    permanently using the Google Analytics Opt <span class=GramE>Out</span> Browser
                    add on.</p>
                ...
                <p><span class=SpellE>CalOPPA</span>
                ...
                <p><b>According to CalOPPA we agree to the
                        following:</b></p>

                <p>Users can visit our site
                    anonymously.</p>

                <p>Once this privacy policy is
                    created, we will add a link to it on our home page or as a minimum on the first
                    significant page after entering our website.</p>

                <p>Our Privacy Policy link includes
                    the word 'Privacy' and can be easily be found on the page specified above.</p>

                

                <p>Users will be notified of any
                    privacy policy changes:</p>

                <p><b>•</b>
                    On our Privacy Policy Page</p>

                <p>Users are able to change their
                    personal information:</p>

                <p><b>•</b>
                    By logging in to their account</p>

                

                <p><b>How does our site handle do not track signals?</b></p>

                <p>We honor do not track signals and
                ...
                <p>It's also important to note that
                    we allow third-party behavioral tracking</p>
                ...
                <p>When it comes to the collection
                    ...
                    children's privacy and safety online.</p>

                

                <p>We do not specifically market to
                    children under 13.</p>
                ...
                <p>The Fair Information Practices
                ...
                <p><b>In order to be in line with Fair Information Practices we will take the
                        following responsive action, should a data breach occur:</b></p>

                <p>We will notify the users via
                    email</p>
                ...
                <p>We also agree to the Individual
                ...
                <p>The CAN-SPAM Act is a law that
                ...
                <p><b>•</b>
                    Process orders and to send information and updates pertaining to orders.</p>
                ...
                <p><b>•</b>
                    ...
                    original transaction has occurred.</p>
                ...
                <p><b>If at any time you would like to unsubscribe from receiving future
                        emails, you can email us at</b></p>

                <p><b>•</b>
                    Follow the instructions at the bottom of each email.</p>

                <p>and we will promptly remove you from <b>ALL</b>
                    correspondence.</p>

                <p><b>Contacting Us</b></p>
                <p>If there are any questions regarding this privacy policy you may contact us using the information below.</p>
                <p>Idea Centric LLC</p>
                <p>39 Grammercy</p>
                <p>Irvine, CA 92612</p>
                <p>USA</p>
