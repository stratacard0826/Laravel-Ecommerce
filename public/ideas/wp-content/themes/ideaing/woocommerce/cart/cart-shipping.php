...
?>
<div class="shipping select-shipping-method">

	<header class="entry-header">
		<h3 class="entry-title-alt"><?php _e('Select shipping method'); ?></h3>
	</header><!-- .entry-header -->
				...
				<li>
					<?php
						printf( '<input type="radio" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d_%2$s" value="%3$s" class="shipping_method" %4$s />
							<label for="shipping_method_%1$d_%2$s" class="sc-checkbox">%5$s</label>',
